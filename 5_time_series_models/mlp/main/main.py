''' Forecasting crypto prices with feed-forward neural network with optimal hyperparameters. '''

import sys
sys.path += ['../../']

from functions import *
from mlp_functions import run_and_log_mlp
...
if __name__=='__main__':
    ...
    Cutoff tuning: {CUTOFF_TUNING}, tuning method: {TUNING_METHOD}\n\n''')
        ...
        for coin in ('btc', 'eth'):
            run_and_log_mlp(mode, coin, args, CUTOFF_TUNING, TUNING_METHOD)
