''' Forecasting crypto prices with (Ridge) OLS / Logistic Regression with
...
from ols_functions import run_and_log_ols
...
if __name__=='__main__':
    ...
    Cutoff tuning: {CUTOFF_TUNING}, tuning method: {TUNING_METHOD}\n\n''')
        ...
        for coin in ('btc', 'eth'):
            run_and_log_ols(mode, coin, args, CUTOFF_TUNING, TUNING_METHOD)
