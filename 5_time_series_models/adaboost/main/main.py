''' Forecasting crypto prices with Adaboost with optimal hyperparameters. '''

import sys
sys.path += ['../../']

from functions import *
from adb_functions import run_and_log_adaboost
...
if __name__=='__main__':
    ...
    Cutoff tuning: {CUTOFF_TUNING}, tuning method: {TUNING_METHOD}\n\n''')
        ...
        for coin in ('btc', 'eth'):
            run_and_log_adaboost(mode, coin, args, CUTOFF_TUNING, TUNING_METHOD)
